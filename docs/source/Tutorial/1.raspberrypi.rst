...
For Bullseye branch systems, use the following commands instead:
...
.. code-block:: bash
    ...
    sudo pip3 install spidev(Optional) 

You can proceed without installing first. If you encounter errors during execution, then install it.
...
.. code-block:: bash
    ...
    sudo pip install spidev (Optional)
