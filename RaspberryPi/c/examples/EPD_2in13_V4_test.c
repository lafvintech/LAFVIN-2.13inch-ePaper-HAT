...
int EPD_2in13_V4_test(void)
{
    ...
    Debug("show bmp------------------------\r\n");
    Paint_SelectImage(BlackImage);
    GUI_ReadBmp("./pic/star.bmp", 0, 0);
    EPD_2in13_V4_Display(BlackImage);
    DEV_Delay_ms(2000);
    
    Debug("show bmp------------------------\r\n");
    Paint_SelectImage(BlackImage);
    GUI_ReadBmp("./pic/moon.bmp", 0, 0);
    EPD_2in13_V4_Display(BlackImage);
    DEV_Delay_ms(2000);
    ...
    Paint_DrawString_EN(140, 15, "LAFVIN", &Font16, BLACK, WHITE);
    Paint_DrawString_EN(140, 40, "HELLO WROLD", &Font12, WHITE, BLACK);
